                        ...
                        <div class="col-12 order-2 order-md-3 order-lg-2 mb-4">
                            <div class="card">
                                <div class="card-header">
                                    <a href="crud_employee.php?xCase=1" class="btn btn-primary"><i class="fa-solid fa-plus me-2"></i>Add Employee</a>
                                </div>
                                <div class="">
                                    <div class="card-body">
                                                ...
                                                ?>
                                                        <tr>
                                                            <th class="text-center sale_ID" style="width: 50px;">
                                                                <?php echo $row['emp_id']; ?></th>
                                                            <th><?php echo $row['emp_firstname'], " ", $row['emp_lastname']; ?>
                                                            </th>
                                                            <td><?php echo $row['emp_email']; ?></td>
                                                            <td><?php echo $row['emp_startworking']; ?></td>
